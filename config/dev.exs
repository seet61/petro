...
config :petro_web, PetroWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "TPtvvyMtn2cZpQWuyxj/vrhquYyNBdu6JypMDbjrDLASGS9dRBpUCTHooHQV7ZU1",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:petro_web, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:petro_web, ~w(--watch)]}
  ]
...
config :petro_web, PetroWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/petro_web/router\.ex$"E,
      ~r"lib/petro_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :petro_web, dev_routes: true
